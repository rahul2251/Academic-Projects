...
<?php
$result=mysqli_query($conn,"SELECT * FROM product WHERE p_category='washing machine' ");
...
?>
      ...
      <h2><b> Washing Machine </b><br>
      Product Name : <?php echo $row['1'];?><br>
      Product ID : <?php echo $row['0'];?><br>
      Price : <?php echo $row['2'];?></h2>
<h3><a href="order.php?p_id=<?php echo $row['0']; ?>">ORDER NOW</a></h3>
    </div></center>
